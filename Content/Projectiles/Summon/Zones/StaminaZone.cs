        ...
        {
            {
                ...
                {
                    Color color = new Color(44, 168, 67) * 0.5f * ((float)(projectile.oldPos.Length - k) / (float)projectile.oldPos.Length) * opacity;

                    float scale = projectile.scale;
                    Texture2D tex = ModContent.GetTexture("CrystalDragons/Content/Projectiles/Summon/Zones/StaminaZone");
