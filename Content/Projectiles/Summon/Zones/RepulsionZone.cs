        ...
        {
            {
                ...
                {
                    Color color = new Color(97, 46, 163) * 0.5f * ((float)(projectile.oldPos.Length - k) / (float)projectile.oldPos.Length) * opacity;

                    float scale = projectile.scale;
                    Texture2D tex = ModContent.GetTexture("CrystalDragons/Content/Projectiles/Summon/Zones/RepulsionZone");
