...
namespace CrystalDragons.Content.Dusts
{
    ...
    internal class AncientInstinctDust : ModDust
    {
        /*
		...
		*/
        ...
        public override bool Update(Dust dust)
        {
            ...
            //    if (player.HasBuff(ModContent.BuffType<OpalGuard>()))
            //    {
            //        timeLeft = player.buffTime[player.FindBuffIndex(ModContent.BuffType<OpalGuard>())];
            //    }
