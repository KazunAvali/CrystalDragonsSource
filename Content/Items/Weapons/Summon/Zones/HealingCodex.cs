...
namespace CrystalDragons.Content.Items.Weapons.Summon.Zones
{
    public class HealingCodex : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            //SpiritGlowmask.AddGlowMask(item.type, "CrystalDragons/Content/Items/Weapons/Summon/Zones/HealingCodex_Glow");
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            spriteBatch.Draw
            (
                mod.GetTexture("Content/Items/Weapons/Summon/Zones/HealingCodex_Glow"),
                new Vector2
                (
