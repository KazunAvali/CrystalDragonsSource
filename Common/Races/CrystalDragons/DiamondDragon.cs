...
{
    public class DiamondDragon : Race
    {
        public override string RaceEnvironmentIcon => ($"CrystalDragons/Common/UI/RaceDisplay/Backgrounds/DiamondCave");
        ...
        public override string RaceSelectIcon => ($"CrystalDragons/Common/UI/RaceDisplay/DiaSelect");
        public override string RaceDisplayMaleIcon => ($"CrystalDragons/Common/UI/RaceDisplay/DiaDisplayMale");
        public override string RaceDisplayFemaleIcon => ($"CrystalDragons/Common/UI/RaceDisplay/DiaDisplayFemale");

        public override string RaceDisplayName => "Diamond Dragon";
        public override string RaceLore1 => "A race of dragonfolk" + "\nwho have affinity" + "\nwith gemstones.";
        public override string RaceLore2 => "Diamond dragons are physically" + "\nstrong and resilient, well-suited" + "\nfor melee combat, but not" + "\nversitility.";
        public override string RaceAbilityName => "Diamond Guard";
        public override string RaceAbilityDescription1 => "[c/34EB93:(Active) Diamond Guard]: Gain invulnerability from damage for 10 seconds and purge all DoT debuffs you're afflicted with.";
        public override string RaceAbilityDescription2 => "In addition, increase aggro by 800 while this ability is active. This ability has a 10 minute cooldown. ";
        ...
        public override string RaceAdditionalNotesDescription1 => "[c/13f0cb:Diamond Gem Boost:] When nearby a filled Diamond Gem Lock, reduces damage taken by 2% per gem (Max -10%).";
        public override string RaceAdditionalNotesDescription2 => "-Diamond dragons are particularly susceptible to alcohol, doubles the duration and both the beneficial and detrimental effects of [c/c4ae08:Tipsy].";
        public override string RaceAdditionalNotesDescription3 => "-Additional [c/FF4F64:-10% damage reduction] while Tipsy.";
        public override string RaceAdditionalNotesDescription4 => "-Immune to the Withered Armor and Broken Armor debuffs.";
        ...
        public override string RaceHealthDisplayText => "[c/34EB93:+15%]";
        public override string RaceRegenerationDisplayText => "";
        public override string RaceManaDisplayText => "[c/FF4F64:-50%]";
        public override string RaceManaRegenerationDisplayText => "";
        public override string RaceDefenseDisplayText => "[c/34EB93:+6]";
        ...
        public override string RaceMeleeDamageDisplayText => "[c/34EB93:+15%]";
        public override string RaceRangedDamageDisplayText => "[c/FF4F64:-25%]";
        public override string RaceMagicDamageDisplayText => "[c/FF4F64:-25%]";
        public override string RaceSummonDamageDisplayText => "[c/FF4F64:-25%]";
        ...
        public override string RaceAggroDisplayText => "[c/34EB93:+400]";
        ...
        public override void ResetEffects(Player player)
        {
            ...
            if (modPlayer.RaceStats)
            {
                ...
                player.statManaMax2 -= (int)(player.statManaMax2 * 0.5f);
            ...
            if (modPlayer.RaceStats)
            {
                if (MrPlagueRaces.MrPlagueRaces.RacialAbilityHotKey.Current)
                {
                    if (!player.HasBuff(ModContent.BuffType<RacialCooldown>()))
                    {
                        if (!player.dead)
                        {
                            //Give the damage immunity
                            player.AddBuff(ModContent.BuffType<DiamondGuard>(), 600, true);
                            Main.PlaySound(SoundID.Item30, player.Center);
                        }
        ...
        public override void ModifyDrawInfo(Player player, Mod mod, ref PlayerDrawInfo drawInfo)
        {
            ...
            if (modPlayer.resetDefaultColors && Main.gameMenu)
            {
                ...
                player.skinColor = new Color(241, 241, 241);
                player.eyeColor = new Color(76, 142, 135);
                player.hairColor = new Color(31, 22, 87);
            }
